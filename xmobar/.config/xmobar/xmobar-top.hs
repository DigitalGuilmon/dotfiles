-- Archivo: xmobar/.config/xmobar/xmobar-top.hs
...
Config { 
    ...
    commands = [ 
        Run DynNetwork ["-t", "<fc=#ff79c6>󰤨 </fc> <rx> KB/s"] 20,
        Run Cpu ["-t", "<fc=#bd93f9> CPU</fc> <total>%"] 20,
    ...
    -- Explicación: %UnsafeStdinReader% contiene "Layout }{ Título"
    -- Al sumarle el tercer }{, Xmobar divide la barra en 3 partes exactas.
